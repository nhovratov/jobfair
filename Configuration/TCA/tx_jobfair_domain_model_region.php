...
$GLOBALS['TCA']['tx_jobfair_domain_model_region'] = array(
		'ctrl' => array(
				'title'	=> 'LLL:EXT:jobfair/Resources/Private/Language/locallang_db.xlf:tx_jobfair_domain_model_region',
				'label' => 'name',
				'tstamp' => 'tstamp',
				'crdate' => 'crdate',
				'cruser_id' => 'cruser_id',
				...
				'iconfile' => 'EXT:jobfair/Resources/Public/Icons/tx_jobfair_domain_model_region.gif'
		),
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_jobfair_domain_model_region.pid=###CURRENT_PID### AND tx_jobfair_domain_model_region.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:jobfair/Resources/Private/Language/locallang_db.xlf:tx_jobfair_domain_model_region.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
