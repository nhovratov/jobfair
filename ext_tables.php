 ...
 * Add folder icon
 *
 * todo: Update for TYPO3 8
 */
if (version_compare(TYPO3_branch, '7.0', '<') || \TYPO3\CMS\Core\Utility\VersionNumberUtility::convertVersionNumberToInteger(TYPO3_version)	< 7000000) {
	$TCA['pages']['columns']['module']['config']['items'][] = array('Job Fair', 'jobfair', \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'/Resources/Public/Icons/folder.gif');
	\TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon('pages', 'contains-jobfair', \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'/Resources/Public/Icons/folder.gif');
} else {
	$TCA['pages']['columns']['module']['config']['items'][] = array('Job Fair', 'jobfair', 'EXT:jobfair/Resources/Public/Icons/folder.gif');
	\TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon('pages', 'contains-jobfair', 'EXT:jobfair/Resources/Public/Icons/folder.gif');
}
